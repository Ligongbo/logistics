    ...
    var titleArray:Array<String> = [String](){
        didSet{
            ...
            if titleArray.count>0{
                ...
                for i in 0..<titleArray.count{
                    let tempTag = 100
                    let titleSize = (titleArray[i] as NSString).boundingRect(with: CGSize.init(width: 0, height: 0), options: .usesLineFragmentOrigin , attributes: [NSAttributedStringKey.font:UIFont.systemFont(ofSize: 13)], context: nil).size
                    if flag{
