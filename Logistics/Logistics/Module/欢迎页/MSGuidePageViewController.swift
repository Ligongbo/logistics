...
//                    btn.frame = CGRect(x: (ScreenWidth - 280) / 2 + CGFloat(kNumberOfPages - 1) * ScreenWidth  + CGFloat(160 * j), y: ScreenHeight - 120, width: 120, height: 44)
                    btn.frame = CGRect(x: ScreenWidth / 2 + CGFloat(kNumberOfPages - 1) * ScreenWidth - 60, y: ScreenHeight - 120, width: 120, height: 44)
                    btn.tag = 1000 + j
