...
- (void)configBottomToolBar {
    ...
    _numberImageView.hidden = tzImagePickerVc.selectedModels.count + self.urlCount <= 0;
    ...
    //TODO
    _numberLabel.text = [NSString stringWithFormat:@"%zd",tzImagePickerVc.selectedModels.count + self.urlCount];
//    _numberLabel.hidden = tzImagePickerVc.selectedModels.count <= 0;
    _numberLabel.hidden = tzImagePickerVc.selectedModels.count + self.urlCount <= 0;
...
- (void)previewButtonClick {
    ...
    photoPreviewVc.urlCount = self.urlCount;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.didSelectPhotoBlock = ^(BOOL isSelected) {
        ...
        if (isSelected) {
            ...
            //TODO
            if (tzImagePickerVc.selectedModels.count + self.urlCount < tzImagePickerVc.maxImagesCount) {
