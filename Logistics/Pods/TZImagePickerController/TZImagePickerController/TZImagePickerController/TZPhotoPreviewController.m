...
- (void)configBottomToolBar {
    ...
    _numberImageView.hidden = _tzImagePickerVc.selectedModels.count + self.urlCount <= 0;
    ...
    _numberLabel.hidden = _tzImagePickerVc.selectedModels.count + self.urlCount <= 0;
...
- (void)refreshNaviBarAndBottomBarState {
    ...
    //TODO
    _numberLabel.text = [NSString stringWithFormat:@"%zd",_tzImagePickerVc.selectedModels.count + self.urlCount];
    _numberImageView.hidden = (_tzImagePickerVc.selectedModels.count + self.urlCount <= 0 || _isHideNaviBar || _isCropImage);
    _numberLabel.hidden = (_tzImagePickerVc.selectedModels.count + self.urlCount <= 0 || _isHideNaviBar || _isCropImage);
